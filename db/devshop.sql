...
CREATE TABLE IF NOT EXISTS `devshop`.`products_variations` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_products_variations_products_idx` (`product_id`),
...
CREATE TABLE IF NOT EXISTS `devshop`.`product_images` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_product_images_products_variations1_idx` (`product_variation_id`),
...
CREATE TABLE IF NOT EXISTS `devshop`.`categories_products` (
  ...
  INDEX `fk_categories_has_products_products1_idx` (`product_id`),
  INDEX `fk_categories_has_products_categories1_idx` (`categorie_id`),
...
CREATE TABLE IF NOT EXISTS `devshop`.`banners` (
  ...
  `order` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_banners_banners_types1_idx` (`banner_type_id`),
